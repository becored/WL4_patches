// @Description Sub_8019E54_WarKeySpringJump_Rewritten
// @HookAddress 0x2DF02C
// @HookString P
// Mode: Thumb
// Made by beco
...
#define byte_83318D8 ((volatile unsigned char *)0x83318D8)
...
int Sub_8019E54_WarKeySpringJump_Rewritten()
{
	if (Wario_ucStat == 8)
	{
		if (Wario_usTimer > 0x12Bu)
			return 254;
		++Wario_usTimer;
	}
	else if (Wario_ucAnmTimer >= byte_83318D8[12 * Wario_ucAnmPat + 61080])
	{
		Wario_ucAnmTimer = 0;
		if (!byte_83318D8[12 * ++Wario_ucAnmPat + 61080])
			Wario_ucAnmPat = 0;
	}
	...
	else if ((Wario_usMukiX ^ 0x30) & KeyPressContinuous[0])
	{
		Wario_usMukiX ^= 0x30u;
		Wario_sMvSpeedX = 0;
	}
	else if (Wario_ucStat == 8)
	{
		Wario_sMvSpeedX = 0;
	}
	return 255;
