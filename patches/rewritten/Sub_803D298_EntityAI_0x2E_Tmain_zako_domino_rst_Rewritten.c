// @Description Sub_803D298_EntityAI_0x2E_Tmain_zako_domino_rst_Rewritten
// @HookAddress 0x78E8B8
// @HookString P
// @EntryFunctionSymbol Sub_803D298_EntityAI_0x2E_Tmain_zako_domino_rst_Rewritten
// Made by beco
// Verison 1.0
...
void Sub_803D298_EntityAI_0x2E_Tmain_zako_domino_rst_Rewritten() {
  ...
  if ( !CurrentEnemyData.CurEnemy_CurrentAnimationId )
    Q_INITIAL_zako_domino_rst();
}

void Q_INITIAL_zako_domino_rst() {
  ...
  CurrentEnemyData.OAMDataPackPointerForCurrentAnimation = unk_83C48D4;
