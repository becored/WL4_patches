// @Description Sub_8010CA0_WarKeySSlip_Rewritten
// @HookAddress 0x2DEDD8
// @HookString P
// Mode: Thumb
// Made by beco
...
int Sub_8010CA0_WarKeySSlip_Rewritten()
{
	// Vanilla code
	int v1; // r0

	Sub_8014090_WarHeadCheck(0, -124, 1);
	if (Wario_usSlope & 1)
		return SLIP;
