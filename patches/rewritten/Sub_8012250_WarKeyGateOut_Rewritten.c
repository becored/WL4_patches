// @Description Sub_8012250_WarKeyGateOut_Rewritten
// @HookAddress 0x2DEE88
// @HookString P
// Mode: Thumb
// Made by beco
...
#define byte_8315FE8 ((volatile unsigned char*) 0x8315FE8)

int Sub_8012250_WarKeyGateOut_Rewritten() {
    // Vanilla code
		if ( Wario_ucAnmTimer < byte_8315FE8[12 * Wario_ucAnmPat + 8] )
	    return 255;
	  Wario_ucAnmTimer = 0;
	  if ( byte_8315FE8[12 * (++Wario_ucAnmPat) + 8] )
	    return 255;
	  if ( !ucShopItemKind )
	    return 2;
	  Wario_usMukiX = 16;
