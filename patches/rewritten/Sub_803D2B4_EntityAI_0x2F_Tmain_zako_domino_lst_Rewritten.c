// @Description Sub_803D2B4_EntityAI_0x2F_Tmain_zako_domino_lst_Rewritten
// @HookAddress 0x78E8BC
// @HookString P
// @EntryFunctionSymbol Sub_803D2B4_EntityAI_0x2F_Tmain_zako_domino_lst_Rewritten
// Made by beco
// Verison 1.0
...
void Sub_803D298_EntityAI_0x2E_Tmain_zako_domino_rst_Rewritten() {
  CurrentEnemyData.CurEnemy_DisableInteractionWithWarioCountdown = 1;
  if ( !CurrentEnemyData.CurEnemy_CurrentAnimationId )
    Q_INITIAL_zako_domino_lst();
}

void Q_INITIAL_zako_domino_lst() {
  CurrentEnemyData.CurEnemy_usStatus |= 0x400;
  CurrentEnemyData.CurEnemy_SizeY0_Bottom = 40;
  CurrentEnemyData.CurEnemy_SizeY1_Top = 0;
  CurrentEnemyData.CurEnemy_SizeX_LeftRight = 40;
  ...
  CurrentEnemyData.OAMDataPackPointerForCurrentAnimation = unk_83C48F4;
