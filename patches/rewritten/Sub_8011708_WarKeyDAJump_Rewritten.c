// @Description Sub_8011708_WarKeyDAJump_Rewritten
// @HookAddress 0x2DEE24
// @HookString P
// Mode: Thumb
// Made by beco
...
int Sub_8011708_WarKeyDAJump_Rewritten()
{
	if (Wario_ucAnmTimer >= byte_82FC2C4[12 * Wario_ucAnmPat + 8])
	{
		Wario_ucAnmTimer = 0;
		if (!byte_82FC2C4[12 * ++Wario_ucAnmPat + 8])
			Wario_ucAnmPat = 0;
	}
	return 255;
}
