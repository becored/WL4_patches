// @Description Sub_8010D1C_WarKeySWalk_Rewritten
// @HookAddress 0x2DEDDC
// @HookString P
// Mode: Thumb
// Made by beco
...
#define byte_82F1380 ((volatile unsigned char *)0x82F1380)
...
int Sub_8010D1C_WarKeySWalk_Rewritten()
{
	// Vanilla code
	signed int v0;	   // r3
	...
	if (Wario_ucTumiki)
		goto LABEL_30;
	v0 = Sub_8014090_WarHeadCheck(0, 0xFF84, 1);
	if (Wario_usSlope & 1)
		return SLIP;
...
LABEL_30:
	if (KeyPressContinuous[0] & Wario_usMukiX)
	{
		...
		if (Wario_ucAnmTimer >= byte_82F1380[12 * Wario_ucAnmPat + 8])
		{
			Wario_ucAnmTimer = 0;
			if (byte_82F1380[12 * ++Wario_ucAnmPat + 8])
			{
				if (Wario_ucAnmPat == 1 || Wario_ucAnmPat == 4)
					Sub_8001DA4_m4aSongNumStart(2);
			}
			else
			{
				Wario_ucAnmPat = 0;
	...
	else if (((Wario_usMukiX ^ 0x30) & KeyPressContinuous[0]) << 16)
	{
		result = STURN;
	}
	else
