// @Description Sub_80299BC_EntityAI_0x03_Tmain_takarabako4
// @HookAddress 0x78E80C
// @HookString P
// @EntryFunctionSymbol Sub_80299BC_EntityAI_0x03_Tmain_takarabako4
// Made by beco
// Verison 1.0
...
#define zako_takara_box_Anm_04 ((unsigned long *)0x83B4F74)

void Sub_80299BC_EntityAI_0x03_Tmain_takarabako4()
{
	int v0; // r0
	...
	case Q_INITIAL:
		...
		CurrentEnemyData.OAMDataPackPointerForCurrentAnimation = zako_takara_box_Anm_04;
		break;
	case Q_INITIAL2:
