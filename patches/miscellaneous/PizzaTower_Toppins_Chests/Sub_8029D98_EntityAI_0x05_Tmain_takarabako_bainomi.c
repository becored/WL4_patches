// @Description Sub_8029D98_EntityAI_0x05_Tmain_takarabako_bainomi
// @HookAddress 0x78E814
// @HookString P
// @EntryFunctionSymbol Sub_8029D98_EntityAI_0x05_Tmain_takarabako_bainomi
// Made by beco
// Verison 1.0
...
#define zako_takara_box_Anm_09 ((unsigned long *)0x83B4FC4)
#define zako_takara_box_Anm_10 ((unsigned long *)0x83B4FF4)
#define zako_takara_box_Anm_11 ((unsigned long *)0x83B5004)

void Sub_8029D98_EntityAI_0x05_Tmain_takarabako_bainomi()
{
	int v0; // r0
	...
	case Q_INITIAL:
		...
		CurrentEnemyData.OAMDataPackPointerForCurrentAnimation = zako_takara_box_Anm_10;
		break;
	case Q_INITIAL2:
	...
	case Q_K5_HIP:
		Q_K2_COM_takarabako();
		CurrentEnemyData.OAMDataPackPointerForCurrentAnimation = zako_takara_box_Anm_09;
		Sub_801E328_EnemyChildSet(
			TAKARA_BAINOMI,
			CurrentEnemyData.CurEnemy_RoomEntitySlotId,
			0,
