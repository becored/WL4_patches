// @Description Sub_8029124_EntityAI_0x08_Tmain_kagi_Rewritten
// @HookAddress 0x78E820
// @HookString P
// @EntryFunctionSymbol Sub_8029124_EntityAI_0x08_Tmain_kagi_Rewritten
// Made by beco
// Verison 1.0
...
void Sub_8029124_EntityAI_0x08_Tmain_kagi_Rewritten() {
  char v0; // r2
  int v1; // r3
  int v2; // r0
...
void Q_INITIAL_kagi() {
  ...
  else
  {
    ...
    CurrentEnemyData.CurEnemy_CurrentAnimationFrameId = HasKeyzer;
