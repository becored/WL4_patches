// @Description Sub_8011280_WarKeyRoll_Rewritten
// @HookAddress 0x2DEDF8
// @HookString P
// Mode: Thumb
// Made by beco
...
#define byte_82F14AC ((volatile unsigned char *)0x82F14AC)
...
int Sub_8011280_WarKeyRoll_Rewritten()
{
	// Vanilla code
	...
	{
		if (Wario_ucAnmTimer >= byte_82F14AC[12 * Wario_ucAnmPat + 8])
		{
			Wario_ucAnmTimer = Wario_ucJpNext;
			if (!byte_82F14AC[12 * ++Wario_ucAnmPat + 8])
			{
				Wario_ucAnmPat = 0;
				WarJEff.ucStat = 5;
			}
