// @Description Sub_8019FD0_WarKeySpringEnd_Rewritten
// @HookAddress 0x2DF040
// @HookString P
// Mode: Thumb
// Made by beco
...
int Sub_8019FD0_WarKeySpringEnd_Rewritten()
{
	signed int v0; // r0
	...
	if (Wario_usMukiX & 0x10)
		...
		v0 = -32;
	Wario_sMvSpeedX = v0;
	if (Wario_ucAnmTimer >= byte_83318D8[12 * Wario_ucAnmPat + 61524])
	{
		Wario_ucAnmTimer = 0;
		if (!byte_83318D8[12 * ++Wario_ucAnmPat + 61524])
			--Wario_ucAnmPat;
	}
	return 255;
}
