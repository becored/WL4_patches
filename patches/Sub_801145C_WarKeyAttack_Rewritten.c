// @Description Sub_801145C_WarKeyAttack_Rewritten
...
int Sub_801145C_WarKeyAttack_Rewritten() {
    // Vanilla code
		signed int result;
	  int v1;
	  int v2;
	  ...
	  {
	    if ( Wario_usMukiX & KeyPressContinuous[0] )
	    {
	      result = WALK;
	    }
	    else
	  ...
	  else
	  {
	    ...
	    else if ( usTrg_KeyPress1Frame[0] & 0x80 )
	    {
	      result = SSLIP;
	    }
